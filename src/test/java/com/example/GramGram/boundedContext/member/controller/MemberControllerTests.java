...
import com.example.GramGram.member.controller.MemberController;
...
@SpringBootTest // 스프링부트 관련 컴포넌트 테스트할때 붙여야함, IoC 컨테이너 작동
@AutoConfigureMockMvc //http 요청, 응답 테스트 위함
@Transactional //테스트에서 발생한 db 작업이 영구적으로 적용되지 않도록함
@ActiveProfiles("test")
public class MemberControllerTests {
    ...
    @Test
    //@Rollback(value = false) //이걸 쓰면 DB에 저장된다 -> Transactional 때문
    @DisplayName("회원가입")
